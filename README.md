...
3. Use `clarify-spec` -> `plan-spec` -> `tasks-spec` -> `analyze-spec` before you implement. When planning a greenfield or cross-feature system, `plan-spec` can first emit a project-level guide in `docs/plans/<topic-slug>.md`.
